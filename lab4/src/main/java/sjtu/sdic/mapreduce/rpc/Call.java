...
public class Call {
  ...
  public static MasterRpcService getMasterRpcService(String address) {
    ConsumerConfig<MasterRpcService> consumerConfig =
        new ConsumerConfig<MasterRpcService>()
  ...
  public static WorkerRpcService getWorkerRpcService(String address) {
    ConsumerConfig<WorkerRpcService> consumerConfig =
        new ConsumerConfig<WorkerRpcService>()
